...
<div class="col-md-12">
    <div class="card mb-4">
        ...
        <form action="{{ route('dailycost.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body row">
                ...
                <div class="mb-3 col-lg-6">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="For Who" value="{{ old('forwho') }}" name="forwho" required />
                    @error('forwho')
                        <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
